...
const CreatePost = () => {
  ...
  const generateImage = async() => {
    if(form.prompt) {
      try {
        ...
        const response = await fetch('https://dell-e-new.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
          <h1 className="font-extrabold text-[@222328] test-[32px]">Create</h1>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
            ...
            <FormField
              ...
              handleChange={handleChange}
              isSurpriseMe
              handleSurpriseNme={handleSurpriseMe}
            />
